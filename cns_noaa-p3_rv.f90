...
IF(iend.GE.1)THEN 
		...
		IF(iend.EQ.2)THEN 
				...
				OPEN(12,file=directory(1:ndir)//'/'//'cfac.fore',form='formatted',status='unknown')
				WRITE(12,400) adjustl(cfac_text01),"=", 0.0
				WRITE(12,400) adjustl(cfac_text02),"=",0.0
				WRITE(12,400) adjustl(cfac_text03),"=",rangevalue_delay_corr_fore
				WRITE(12,400) adjustl(cfac_text04),"=",0.0
				WRITE(12,400) adjustl(cfac_text05),"=",0.0
				WRITE(12,400) adjustl(cfac_text06),"=",pressure_alt_corr
				WRITE(12,400) adjustl(cfac_text07),"=",0.0
				WRITE(12,400) adjustl(cfac_text08),"=",ew_gndspd_corr
				WRITE(12,400) adjustl(cfac_text09),"=",0.0
				WRITE(12,400) adjustl(cfac_text10),"=", 0.0
				WRITE(12,400) adjustl(cfac_text11),"=", 0.0
				WRITE(12,400) adjustl(cfac_text12),"=", 0.0
				WRITE(12,400) adjustl(cfac_text13),"=", pitch_corr_cfac
				WRITE(12,400) adjustl(cfac_text14),"=", drift_corr_cfac
				WRITE(12,400) adjustl(cfac_text15),"=", rot_angle_corr_fore
				WRITE(12,400) adjustl(cfac_text16),"=", tilt_corr_fore
				CLOSE(12)
