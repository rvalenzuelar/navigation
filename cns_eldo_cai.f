...
c
      ...
      parameter (nvar=12,nxysurfmax=4400)
c
...
! MB:
! iolat_dtm and iolon_dtm are the reference  latitude and longitude points.
! ixmin and iymin define the lower left corner relative to the lat/lon point
! nx and ny are the number of points in each direction
! ihx and ihy are the resolution of the data        
...
c CAI STOP
	olat_dtm=float(iolat_dtm)/1000.        ! [deg]
	olon_dtm=float(iolon_dtm)/1000.       ! [deg]
	xlatm_surf=(olat_dtm+orig_lat)/2.      ! [deg] ;  average domain latitude
  ...
  !-----------------------------------------------------
      ! print *,'    olat_dtm ; olon_dtm :',olat_dtm,olon_dtm
      ! print *,'    orig_lat ; orig_lon :',orig_lat,orig_lon
      ! print *,'    deg_lon, deg_lat :',deg_lon,deg_lat
      ! print *,'    dx_dtm,dy_dtm :',dx_dtm,dy_dtm
      ! print *,'  '
  !------------------------------------------------------(RV)
...
c           print *,'swdzsurf_sweep(iradar_ray) :',
c      &     swdzsurf_sweep(iradar_ray) ! RV (=0)
...
c******************************************************************
c
      ! print *,'kdzsurf+kvsurf = ', kdzsurf+kvsurf ! RV (=2_)
      ! print *,'selh ; selh_surf= ', selh,selh_surf ! RV 
      ! print *,'z_acft ; zacftmin_surf= ', z_acft, zacftmin_surf ! RV 
...
c******************************************************************
c
      ! print *,'        REFMAX_ray :',refmax_ray ! RV
